...
Or use the static site directly: `open frontend/static-site/index.html` -- this will give you the same code sandbox that is hosted at [quevivasbien.github.io/gema](quevivasbien.github.io/gema).
...
bun test --todo       # List unimplemented features
